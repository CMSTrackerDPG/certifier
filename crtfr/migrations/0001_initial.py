    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pixel_problems",
                    models.ManyToManyField(blank=True, to="crtfr.PixelProblem"),
                ),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="oms.OmsRun"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="runreconstruction", unique_together={("run", "reconstruction")}
        ),
        migrations.AddField(
